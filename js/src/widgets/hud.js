(function($) {
  ...
  $.Hud.prototype = {
    ...
    template: $.Handlebars.compile([
                                 ...
                                 '</a>',
				 '<a class="hud-control mirador-osd-rotate-right" aria-label="{{t "rotateRightTooltip"}}" title="{{t "rotateRightTooltip"}}">',
                                 '<i class="fa fa-lg fa-rotate-right"></i>',
                                 '</a>',
                                 '<a class="hud-control mirador-osd-rotate-left" aria-label="{{t "rotateLeftTooltip"}}" title="{{t "rotateLeftTooltip"}}">',
