(function($) {
  ...
  $.Hud.prototype = {
    ...
    template: $.Handlebars.compile([
                                 ...
                                 '</a>',
				 '<a class="mirador-osd-rotate-right hud-control" aria-label="{{t "rotateRightTooltip"}}" title="{{t "rotateRightTooltip"}}">',
                                 '<i class="fa fa-lg fa-rotate-right"></i>',
                                 '</a>',
                                 '<a class="mirador-osd-rotate-left hud-control" aria-label="{{t "rotateLeftTooltip"}}" title="{{t "rotateLeftTooltip"}}">',
